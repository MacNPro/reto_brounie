...
public class ImagenReader extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "ImagenReader.db";
    ...
    private static final String SQL_DELETE_ENTRIES =
            "DROP TABLE IF EXISTS " + ImagenEntry.TABLE_NAME;

    public ImagenReader(Context context) {
